...
*{padding:0px;margin:0px;}
   ...
   .box3{width:50%;height:auto;float:left;padding:50px 0px 50px 0px;margin:30px 0px 0px 30px;border:1px solid #ccc;z-index:999;}
   .box4{float:left;z-index:999;margin-top:100px;margin:30px 0px 0px 30px;}
</style>
</head>
<body>
 <div class="box">
